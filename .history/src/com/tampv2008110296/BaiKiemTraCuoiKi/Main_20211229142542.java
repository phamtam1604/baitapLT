      ...
      Scanner input = new Scanner(System.in);
        Menu();
          while(true){
              ...
              switch(luachon){
                  case 1:
                   sieuthi.them(Hanghoa);
                   break;
                  case 2:
                   sieuthi.clear(Hanghoa);
                  case 5: return; 
              }
          }
    }
